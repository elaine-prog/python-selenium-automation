...
#By XPATH
driver.find_element(By.XPATH,"//input[@placeholder='SearchAmazon']")
driver.find_element(By.XPATH, "//a[@href='nav_logo']")
# By XPATH, any tag
driver.find_element(By. XPATH, '//*[@placeholder="SearchAmazon"]')
